...
public class EnemySpawner : MonoBehaviour {
    ...
    public void SurvivalSpawnEnemy(GameObject enemyToSpawn)
    {
        ...
        {
            EnemySpawned.GetComponent<EnemyAI>().FindPlayers();
            EnemySpawned.GetComponent<EnemyAI>().lookForPlayer = true;
        }

        if (towerDefenseAI)
        {
            EnemySpawned.GetComponent<EnemyAI>().towerDefenseAI = true;
            if (towerDefenseTarget)
                EnemySpawned.GetComponent<EnemyAI>().towerDefenseTarget = towerDefenseTarget;
        }
